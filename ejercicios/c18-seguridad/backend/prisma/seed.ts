...
const autores = [
  ...
  { nombre: 'Julio Cortazar', nacionalidad: 'Argentina', nacimiento: 1914 },
  { nombre: 'Gabriel Garcia Marquez', nacionalidad: 'Colombiana', nacimiento: 1927 },
];
...
const usuarios = [
  { email: 'admin@libreria.com', password: 'Admin123!', nombre: 'Admin Libreria', rol: Rol.ADMIN },
  { email: 'cliente@libreria.com', password: 'Cliente123!', nombre: 'Cliente Libreria', rol: Rol.CLIENTE },
];
